...
<% 
 ...
 %>
      ...
      <div id="box">
	<ul id="tab_nav">
    	<li><a href="#t_1">Pilots</a></li>
        <li><a href="#t_2">Navigators </a></li>
        <li><a href="#t_3">Radio operators</a></li>
        <li><a href="#t_3">Stewardesses</a></li>
    </ul>
    <div id="tab_content">
    	<div id="t_1">
       <h1>Pilots</h1> <br>
       ...
       <tr><td bgcolor="#FF9900">ID</td><td> 
       <tr><td bgcolor="#FF9900">Age</td><td> 
       <tr><td bgcolor="#FF9900">Gender</td><td>
       <tr><td bgcolor="#FF9900">First Name</td><td>
       <tr><td bgcolor="#FF9900">Last Name</td><td>
       <tr><td bgcolor="#FF9900">Edit</td><td> 
       <tr><td bgcolor="#FF9900">Delete</td><td>
        <c:forEach items="${pilot}" var="pilot" >
          <tr>
             ...
             <td>
                <a href="editPilot?id=${pilot.id}">Edit</a>
             </td>
             <td>
                <a href="deletePilot?id=${pilot.id}">Delete</a>
             </td>
          </tr>
       </c:forEach>
       </table>
        <a href="createPilot" >createPilot</a>
