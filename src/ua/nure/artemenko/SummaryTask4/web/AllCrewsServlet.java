...
@WebServlet(urlPatterns = { "/allCrews" })
public class AllCrewsServlet extends HttpServlet{

	private static final long serialVersionUID = 7175304684036370379L;
	
	public AllCrewsServlet() {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Crew> list = null;
        try {
        	list = DBManager.getInstance().findAllCrews(con);
        } catch (Exception e) {
            e.printStackTrace();
        ...
        RequestDispatcher dispatcher = request.getServletContext()
                .getRequestDispatcher("/WEB-INF/views/dispatcher/allCrews.jsp");
