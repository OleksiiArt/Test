...
@WebServlet(urlPatterns = { "/pilots" })
public class PilotsServlet extends HttpServlet{

	private static final long serialVersionUID = 459222957557176151L;
	...
	public PilotsServlet() {
	 ...
	 protected void doGet(HttpServletRequest request, HttpServletResponse response)
	        ...
	        try {
         list = DBManager.getInstance().findPilot(con);
	        } catch (Exception e) {
	            e.printStackTrace();
	        ...
	        RequestDispatcher dispatcher = request.getServletContext()
	                .getRequestDispatcher("/WEB-INF/views/admin/pilots.jsp");
